...
> **Superseded by v0.6 (2026-05-03, cy-003 r1)** — 본 v0.5 는 cy-002 r2 *8 핵심 문서 도달* baseline 자리로 보존. 활성 baseline = [bible-v0.6.md](./bible-v0.6.md) (인물 8 자리 절 + 축 매핑 다축 박음 룰 thin-patch). 신규 산출물은 v0.6 참조 박음 의무.
